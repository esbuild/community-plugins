...
* [esbuild-plugin-hjson](https://github.com/ChildishGiant/esbuild-plugin-hjson) A simple plugin to allow [`*.hsjon`](https://hjson.github.io/) files to be imported.
...
* [@linjiajian999/esbuild-plugin-import](https://github.com/linjiajian999/esbuild-plugin-import): A plugin that modular import, similar to [babel-plugin-import](https://github.com/ant-design/babel-plugin-import).
